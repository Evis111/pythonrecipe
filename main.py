...
if __name__ == '__main__':
    file_with_recipes = os.path.abspath(r'D:\pythonrecipe\Recipe')
    ...
    file_for_writing = os.path.abspath(r'D:\pythonrecipe\Result')
    base_path = os.getcwd()
    location = os.path.abspath(r'D:\pythonrecipe\Result')
